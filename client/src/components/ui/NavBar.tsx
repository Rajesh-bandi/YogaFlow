            ...
            <div className="flex items-center space-x-3">
              {!loggedIn ? (
                ...
                <div className="relative">
                  ...
                  {showDropdown && (
                    <div
                      className="absolute right-0 mt-2 bg-white border rounded shadow z-50 min-w-[120px] py-1 text-sm"
                      style={{ top: '100%' }}
                    >
                      <button
              ...
              <div className="flex flex-col space-y-3 pt-2">
                {!loggedIn ? (
                  ...
                  <div className="relative">
                    ...
                    {showDropdown && (
                      <div
                        className="absolute left-0 w-full mt-2 bg-white border rounded shadow z-50 min-w-[120px] py-1 text-sm"
                        style={{ top: '100%' }}
                      >
                        <button
                          className="w-full px-3 py-1 text-left hover:bg-gray-100 rounded"
